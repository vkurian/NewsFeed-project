...
<html>
	...
	<body>
		...
		<form id = "login" class = "input-text" method="POST" action="login.php">
			...
			<input type = "password" class = "inputting-text" placeholder = "Enter Password" name="userPwd" required>
			<input type = "checkbox" class = "check-box"><span>Remember Password</span>
        	<button type = "submit" class = "submit-botton">Log In</button>  
			</br>
        <a href="../Forgot_password/forgotindex.html" class="info-btn">Forgot Password</a>
		</form>
